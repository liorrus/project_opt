...
#df_fac = factorizeData(train_df)
#print(df_fac.head())	

def getShotsResAgaintDefPlayer(df):
	#for row in df
	pass
...
def createdf():
	with open('shot_logs.csv', newline='') as csvfile:
		...
		df.to_csv("train_befor_factor.csv")
		return df

warnings.filterwarnings('ignore')
df1 = createdf()
df2 = factorizeData(df1)
print(df2[["player_id",'made_avg']].head())
df2.to_csv('shot_log_train_factorized.csv')
